...
void Node::addUtility(int score) { utility = ((utility* (visits - 1)) + score / 100.0) / static_cast<double>(visits); }

int Node::getVisits() { return visits; }

double Node::getUtility() { return utility; }

Node* Node::getParent() { return parent; }

State Node::getState() { return state; }
